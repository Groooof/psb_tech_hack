...
INSERT INTO fns (surname, name, patronymic, inn, birthday, document_type, passport_series, passport_number)
VALUES
    ('Бобров', 'Андрей', 'Андреевич', '000000000001', '2000-05-03', 'паспорт', '0001', '000001'),
    ('Харитонов', 'Марк', 'Петрович', '000000000002', '1995-11-14', 'паспорт', '0002', '000002'),
    ('Гаврилов', 'Алекандр', 'Алексеевич', '000000000003', '2002-06-23', 'паспорт', '0003', '000003'),
    ('Левин', 'Егор', 'Юрьевич', '000000000004', '1994-05-01', 'паспорт', '0004', '000004'),
    ('Виноградов', 'Александр', 'Алексеевич', '000000000005', '1999-04-16', 'паспорт', '0005', '000005'),

    ('Иванова', 'Алиса', 'Леонидовна', '000000000006', '1995-04-19', 'паспорт', '0006', '000006'),
    ('Николаева', 'Алисия', 'Александровна', '000000000007', '2001-10-23', 'паспорт', '0007', '000007'),
    ('Данилов', 'Максим', 'Даниилович', '000000000008', '1990-02-10', 'паспорт', '0008', '000008'),
    ('Ермаков', 'Максим', 'Владимирович', '000000000009', '1998-06-30', 'паспорт', '0009', '000009'),
    ('Ковалева', 'Евгения', 'Елисеевна', '000000000010', '1996-05-05', 'паспорт', '0010', '000010');
...
INSERT INTO bki (passport_series, passport_number, liability_amount, overdue)
VALUES
    ('0001', '000001', 300000, False),
    ('0002', '000002', 1000000, False),
    ('0003', '000003', 250000, False),
    ('0004', '000004', 400000, True),
    ('0005', '000005', 240000, False),
    ('0006', '000006', 200000, False),
    ('0007', '000007', 450000, False),
    ('0008', '000008', 2000000, True),
    ('0009', '000009', 900000, False),
